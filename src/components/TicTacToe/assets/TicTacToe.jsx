...
import WinnerMsgComp from "./WinnerMsgComp";
...
function TicTacToe() {
  ...
  function checkWinner() {
    ...
    for (let pattern of winningPattern) {
      ...
      let pos0 = board[pattern[0]].value !== null ? board[pattern[0]].value : "-";
      let pos1 = board[pattern[1]].value !== null ? board[pattern[1]].value : "-";
      let pos2 = board[pattern[2]].value !== null ? board[pattern[2]].value : "-";
  ...
  return (
    <main className={styles.gameBack}>
      <WinnerMsgComp winnerState={isWinner} winnerStr={winnerStr} resetBoxes={resetBoxes} />
